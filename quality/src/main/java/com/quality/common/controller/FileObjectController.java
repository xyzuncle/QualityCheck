...
import com.quality.common.fastdfs.FileCheck;
...
public class FileObjectController {
    ...
    public void downloadImage(String filePath, HttpServletResponse response) throws BaseException {
        try {
