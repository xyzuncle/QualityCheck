...
import com.quality.common.constants.ErrorCode;
...
/**
 * @Description: 用于fastdfs的文件上传
 * @Author: yerui
 * @CreateDate : 2018/11/26 11:15
 * @Version: 1.0
 *
 */
public class FastDFSClient {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithMultipart(MultipartFile file) throws BaseException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithMultipart(MultipartFile file, Map<String, String> descriptions) throws BaseException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithFilepath(String filepath) throws BaseException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithFilepath(String filepath, Map<String, String> descriptions) throws BaseException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithBase64(String base64) throws BaseException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithBase64(String base64, String filename) throws BaseException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithBase64(String base64, String filename, Map<String, String> descriptions) throws BaseException {
     ...
     * @param descriptions 文件描述信息
     * @return 文件路径
     * @throws com.quality.common.exception.BaseException file为空则抛出异常
     */
    public String upload(MultipartFile file, Map<String, String> descriptions) throws BaseException {
        if(file == null || file.isEmpty()){
            throw new BaseException(ErrorCode.FILE_ISNULL.MESSAGE,ErrorCode.FILE_ISNULL.CODE);
        }
        String path = null;
        try {
     ...
     * @param descriptions 文件描述
     * @return 文件路径
     * @throws BaseException 文件路径为空则抛出异常
     */
    public String upload(String filepath, Map<String, String> descriptions) throws BaseException {
        if(StringUtils.isBlank(filepath)){
            throw new BaseException(ErrorCode.FILE_PATH_ISNULL.MESSAGE,ErrorCode.FILE_PATH_ISNULL.CODE);
        }
        ...
        try {
            ...
            e.printStackTrace();
            throw new BaseException(ErrorCode.FILE_NOT_EXIST.MESSAGE,ErrorCode.FILE_NOT_EXIST.CODE);
        }
     ...
     * @param descriptions 文件描述信息
     * @return 文件路径
     * @throws BaseException base64为空则抛出异常
     */
    public String upload(String base64, String filename, Map<String, String> descriptions) throws BaseException {
     ...
     */
    public String upload(InputStream is, String filename, Map<String, String> descriptions) throws BaseException {
        if(is == null){
            throw new BaseException(ErrorCode.FILE_ISNULL.MESSAGE,ErrorCode.FILE_ISNULL.CODE);
        }
        ...
        try {
            if(is.available() > maxFileSize){
                throw new BaseException(ErrorCode.FILE_OUT_SIZE.MESSAGE,ErrorCode.FILE_OUT_SIZE.CODE);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            if(StringUtils.isBlank(path)) {
                throw new BaseException(ErrorCode.FILE_UPLOAD_FAILED.MESSAGE,ErrorCode.FILE_UPLOAD_FAILED.CODE);
            }
     ...
     * @param response
     */
    public void downloadFile(String filepath, HttpServletResponse response) throws BaseException {
     ...
     * @param os 输出流
     */
    public void downloadFile(String filepath, OutputStream os) throws BaseException {
     ...
     */
    public void downloadFile(String filepath, String filename, HttpServletResponse response) throws BaseException {
     ...
     * @param response HttpServletResponse
     */
    public void download(String filepath, String filename, OutputStream os, HttpServletResponse response) throws BaseException {
        if(StringUtils.isBlank(filepath)){
            throw new BaseException(ErrorCode.FILE_PATH_ISNULL.MESSAGE,ErrorCode.FILE_PATH_ISNULL.CODE);
        }
        ...
        try {
            ...
            e.printStackTrace();
            throw new BaseException(ErrorCode.FILE_DOWNLOAD_FAILED.MESSAGE,ErrorCode.FILE_DOWNLOAD_FAILED.CODE);
        } finally {
            // 关闭流
            try {
                if(is != null){
     ...
     * @throws BaseException
     */
    public byte[] download(String filepath) throws BaseException {
        if(StringUtils.isBlank(filepath)){
            throw new BaseException(ErrorCode.FILE_PATH_ISNULL.MESSAGE,ErrorCode.FILE_PATH_ISNULL.CODE);
        }
     ...
     */
    public int deleteFile(String filepath) throws BaseException {
        if(StringUtils.isBlank(filepath)){
            throw new BaseException(ErrorCode.FILE_PATH_ISNULL.MESSAGE,ErrorCode.FILE_PATH_ISNULL.CODE);
        }
        ...
        try {
            ...
            if(success != 0){
                throw new BaseException(ErrorCode.FILE_DELETE_FAILED.MESSAGE,ErrorCode.FILE_DELETE_FAILED.CODE);
            }
        } catch (IOException e) {
            e.printStackTrace();
        } catch (MyException e) {
     ...
     * </pre>
     */
    public Map<String, Object> getFileInfo(String filepath) throws BaseException {
        TrackerServer trackerServer = TrackerServerPool.borrowObject();
        StorageClient1 storageClient = new StorageClient1(trackerServer, null);
     ...
     * @return 文件描述信息
     */
    public Map<String, Object> getFileDescriptions(String filepath) throws BaseException {
        TrackerServer trackerServer = TrackerServerPool.borrowObject();
        StorageClient1 storageClient = new StorageClient1(trackerServer, null);
        NameValuePair[] nvps = null;
        try {
     ...
     * @return 文件名称
     */
    public String getOriginalFilename(String filepath) throws BaseException {
