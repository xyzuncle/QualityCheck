 ...
 * @since 2019-02-27
 */
@ApiModel(value="QualityStoreOut对象", description="")
public class QualityStoreOut extends BaseEntity {
    ...
    @ApiModelProperty(value = "0 损坏 1 正常 2 维修")
